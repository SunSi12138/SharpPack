...
public class CircularReferenceTest
{
    ...
    public void MicrosoftExample()
    {
        ...
        var bin = SharpPackSerializer.Serialize(tyler);
        Employee? tylerDeserialized = SharpPackSerializer.Deserialize<Employee>(bin);
    ...
    public void NodeTest()
    {
        ...
        var bin = SharpPackSerializer.Serialize(parent);
        var value2 = SharpPackSerializer.Deserialize<Node>(bin);
    ...
    public void PureNodeTest()
    {
        ...
        var bin = SharpPackSerializer.Serialize(node);
        var value2 = SharpPackSerializer.Deserialize<PureNode>(bin);
    ...
    public void InHolder()
    {
        ...
        var bin = SharpPackSerializer.Serialize(holder);
        var value2 = SharpPackSerializer.Deserialize<CircularHolder>(bin);
    ...
    public void Sequential()
    {
        ...
        var bin = SharpPackSerializer.Serialize(tyler);
        SequentialCircularReference? tylerDeserialized = SharpPackSerializer.Deserialize<SequentialCircularReference>(bin);
    ...
    public void ExplicitContext_PreservesSelfMutualAndSharedReferences()
    {
        ...
        var payload = SharpPackSerializer.Serialize(root, context);
        var decoded = SharpPackSerializer.Deserialize<Node>(payload, context)!;
