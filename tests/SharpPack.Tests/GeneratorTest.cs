...
public class GeneratorTest
{
    ...
    static void NoMember<T>(T? value)
    {
        ...
        T? value2 = SharpPackSerializer.Deserialize<T>(bin);
    ...
    public void Null()
    {
        var bin = SharpPackSerializer.Serialize<StandardTypeOne>(null);
        SharpPackSerializer.Deserialize<StandardTypeOne>(bin).Should().BeNull();
    }
    ...
    public void MethodInvoke()
    {
        ...
        var bin = SharpPackSerializer.Serialize(mc);
        ...
        MethodCall.Log.Clear();
        SharpPackSerializer.Deserialize<MethodCall>(bin, ref mc);
        ...
        MethodCall.Log.Clear();
        SharpPackSerializer.Deserialize<MethodCall>(bin);
        ...
        // allow null
        MethodCall.Log.Clear();
        var bin2 = SharpPackSerializer.Serialize((MethodCall?)null);
        MethodCall.Log.Should().Equal("OnSerializing1", "OnSerializing_M1", "OnSerialized1", "OnSerialized_M1");

        MethodCall.Log.Clear();
        SharpPackSerializer.Deserialize<MethodCall>(bin2);
    ...
    public void Union()
    {
        // interface
        {
            ...
            IUnionInterface b = new Impl2 { MyProperty = 1000, Bar = "foobarbaz" };
            {
                ...
                var a1 = SharpPackSerializer.Deserialize<IUnionInterface>(bin);
            ...
            {
                var bin = SharpPackSerializer.Serialize(b);
                var b1 = SharpPackSerializer.Deserialize<IUnionInterface>(bin);
        ...
        // abstract
        {
            ...
            {
                var bin = SharpPackSerializer.Serialize(a);
                var a1 = SharpPackSerializer.Deserialize<UnionAbstractClass>(bin);
            ...
            {
                var bin = SharpPackSerializer.Serialize(b);
                var b1 = SharpPackSerializer.Deserialize<UnionAbstractClass>(bin);
    ...
    public void Versioning()
    {
        ...
        var bin0 = SharpPackSerializer.Serialize(v0);
        ...
        // small -> large is ok.
        var v0Tov4 = SharpPackSerializer.Deserialize<Versioning4>(bin0);
        var v1Tov4 = SharpPackSerializer.Deserialize<Versioning4>(bin1);
        var v2Tov4 = SharpPackSerializer.Deserialize<Versioning4>(bin2);
        var v3Tov4 = SharpPackSerializer.Deserialize<Versioning4>(bin3);
        var v4Tov4 = SharpPackSerializer.Deserialize<Versioning4>(bin4);
        ...
        // large -> small is ng
        Assert.Throws<SharpPackSerializationException>(() => SharpPackSerializer.Deserialize<Versioning2>(bin3));

        // check wrapped
        var w2 = new WrappedVersioning2 { Before = "BF", V2 = v2, After = "AF" };
        var binw2 = SharpPackSerializer.Serialize(w2);

        var w4 = SharpPackSerializer.Deserialize<WrappedVersioning4>(binw2);
    ...
    public void Recursive()
    {
        ...
        // ok to serialize
        var bin = SharpPackSerializer.Serialize(rec);
        var newRec = SharpPackSerializer.Deserialize<Recursive>(bin);
        ...
        //set rec
        rec.Rec = rec;
        Assert.Throws<SharpPackSerializationException>(() => SharpPackSerializer.Serialize(rec));
    }

    [Fact]
    public void ManyMemebrs()
    {
        SharpPackSerializer.Serialize(new ManyMembers());
    }
    ...
    public void Generics()
    {
        ...
        var bin = SharpPackSerializer.Serialize(comp);
        var two = SharpPackSerializer.Deserialize<MoreComplecsGenerics<int, string>>(bin);
        ...
        var binA = SharpPackSerializer.Serialize<IGenericUnion<long>>(a);
        var binB = SharpPackSerializer.Serialize<IGenericUnion<long>>(b);

        var a2 = SharpPackSerializer.Deserialize<IGenericUnion<long>>(binA);
        var b2 = SharpPackSerializer.Deserialize<IGenericUnion<long>>(binB);
    ...
    public void Overwrite()
    {
        ...
        var bin = SharpPackSerializer.Serialize(v1);
        ...
        var v1_original = v1;
        SharpPackSerializer.Deserialize(bin, ref v1);
        ...
        var bin2 = SharpPackSerializer.Serialize(v4);
        var v4_original = v4;
        v4.MyProperty1 = 9999;

        SharpPackSerializer.Deserialize(bin2, ref v4);
