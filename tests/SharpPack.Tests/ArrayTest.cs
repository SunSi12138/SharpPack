...
public class ArrayTest
{
    ...
    public void Check()
    {
        ...
        var bin = SharpPackSerializer.Serialize(checker);
        var v2 = SharpPackSerializer.Deserialize<ArrayCheck>(bin);
    ...
    public void Check2()
    {
        ...
        var bin = SharpPackSerializer.Serialize(checker);
        var v2 = SharpPackSerializer.Deserialize<ArrayOptimizeCheck>(bin);
#pragma warning disable CS8602
    ...
    public void BoolArray()
    {
        ...
        for (int i = 0; i < 1000; i++)
        {
            ...
            var value2 = SharpPackSerializer.Deserialize<BitPackSingleData>(bin);
        ...
        for (int i = 0; i < 1000; i++)
        {
            ...
            var bin = SharpPackSerializer.Serialize(value);
            var value2 = SharpPackSerializer.Deserialize<BitPackData>(bin);
    ...
    public void BitPackRejectsTruncatedInput()
    {
        ...
        using var readerState = SharpPackReaderOptionalStatePool.Rent();
        var reader = new SharpPackReader(
    ...
    //    var bin = SharpPackSerializer.Serialize(memow);
    //    var value2 = SharpPackSerializer.Deserialize<IMemoryOwner<byte>>(bin);
