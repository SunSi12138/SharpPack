...
public class CustomFormatterTest
{
    ...
    public void Check()
    {
        ...
        var bin1 = SharpPackSerializer.Serialize(value, utf8);
        var bin2 = SharpPackSerializer.Serialize(value, utf16);

        var v1 = SharpPackSerializer.Deserialize<CustomFormatterCheck>(bin1, utf8);
        var v2 = SharpPackSerializer.Deserialize<CustomFormatterCheck>(bin2, utf16);
    ...
    public void Pool()
    {
        ...
        var bin = SharpPackSerializer.Serialize(forPool);
        var v2 = SharpPackSerializer.Deserialize<MemoryPoolModel>(bin);
