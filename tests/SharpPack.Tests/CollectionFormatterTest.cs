...
public class CollectionFormatterTest
{
        ...
        where T : IEnumerable<int>
    {
        ...
        var value2 = SharpPackSerializer.Deserialize<T>(bin);
        ...
        where T : class, IEnumerable<int>
    {
        ...
        var original = value;
        clear(value);
        var expected = SharpPackSerializer.Deserialize<T>(bin);
        SharpPackSerializer.Deserialize<T>(bin, ref value);
    ...
    public void List()
    {
        ...
        var bin = SharpPackSerializer.Serialize(list);

        // no ref
        SharpPackSerializer.Deserialize<List<int>>(bin).Should().Equal(list);

        // ref and same length
        var list2 = new List<int>() { 10, 20, 30, 40, 50 };
        SharpPackSerializer.Deserialize(bin, ref list2);
        list2.Should().Equal(list);

        // ref and differenct length
        var list3 = new List<int>() { 99, 98, 97 };
        SharpPackSerializer.Deserialize(bin, ref list3);
    ...
    public void Stack()
    {
        ...
        var bin = SharpPackSerializer.Serialize(stack);

        // no ref
        SharpPackSerializer.Deserialize<Stack<int>>(bin).Should().Equal(stack);

        // ref and same length
        var stack2 = new Stack<int>();
        Push(stack2, 10, 20, 30, 40, 50);
        SharpPackSerializer.Deserialize(bin, ref stack2);
        stack2.Should().Equal(stack);

        // ref and differenct length
        var stack3 = new Stack<int>();
        Push(stack3, 99, 98, 97);
        SharpPackSerializer.Deserialize(bin, ref stack3);
    ...
    public void PriorityQueue()
    {
        ...
        var bin = SharpPackSerializer.Serialize(collection);
        var v2 = SharpPackSerializer.Deserialize<PriorityQueue<int, int>>(bin);
    ...
    public void Collection()
    {
        ...
        }
        {
            ...
            var bin = SharpPackSerializer.Serialize(collection);
            // not gurantees order
            SharpPackSerializer.Deserialize<Stack<int>>(bin).Should().BeEquivalentTo(collection);
        }
        {
    ...
    {
        {
            ...
            SharpPackSerializer.Deserialize<Dictionary<int, int>>(bin).Should().BeEquivalentTo(dict);
        }
        {
            ...
            var bin = SharpPackSerializer.Serialize(dict);
            SharpPackSerializer.Deserialize<SortedDictionary<int, int>>(bin).Should().BeEquivalentTo(dict);
        }
        {
            ...
            var bin = SharpPackSerializer.Serialize(dict);
            SharpPackSerializer.Deserialize<SortedList<int, int>>(bin).Should().BeEquivalentTo(dict);
        }
        {
