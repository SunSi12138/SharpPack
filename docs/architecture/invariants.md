...
| Generated-code ABI | Generated formatters may call the documented CLR-public hidden surface. | Removing or changing such a member merely because it is hidden from IntelliSense. | `FormatterGenerationTest.FrozenGeneratedCodeAbi_CompilesAgainstCurrentRuntime`, generated-source characterization, and `generated-code-abi.md`. |
