...
| Generated-code ABI | Generated formatters may call the documented CLR-public hidden surface. | Removing or changing such a member merely because it is hidden from IntelliSense. | Public API compatibility gate and generated-source characterization; see `generated-code-abi.md`. |
