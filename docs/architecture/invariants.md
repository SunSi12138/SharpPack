...
| Public API surface | Add CLR-public API only with explicit review and an intentional baseline update. | Removing, narrowing, or changing the signature or trimming/NativeAOT contract of a shipped `SharpPack.Core` or `SharpPack.Streaming` API in 1.x, including public-hidden generated-code ABI; changing the published Generator host entry point without review. | `eng/baselines/public-api/SharpPack.Core.txt`, `eng/baselines/public-api/SharpPack.Streaming.txt`, `eng/baselines/public-api/SharpPack.Generator.txt`, `tools/SharpPack.Baselines` verification, and the negative characterization script. |
| Generated-code ABI | Generated formatters may call the documented CLR-public hidden surface; intentional emitter changes may update the representative snapshot after review. | Removing a covered runtime ABI or accepting an unexplained generated-source rewrite. | `FormatterGenerationTest.FrozenGeneratedCodeAbi_CompilesAgainstCurrentRuntime`, `eng/baselines/generated/representative.g.cs.txt`, and `tools/SharpPack.Baselines` verification. |
