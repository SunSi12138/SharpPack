...
{
    public static readonly string SharpPackWriter = """
// Code of SharpPack
...
export class SharpPackWriter {
    static singletonWriter: SharpPackWriter;

    public static getSharedInstance(): SharpPackWriter {
        if (this.singletonWriter == null) {
            this.singletonWriter = new SharpPackWriter();
        }
    ...
    public writeArray<T>(value: ArrayLike<T> | null, elementWriter: (writer: SharpPackWriter, element: T) => void): void {
        if (value == null) {
            this.writeNullCollectionHeader();
            return;
        }
    ...
    public writeMap<K, V>(value: Map<K, V> | null, keyWriter: (writer: SharpPackWriter, key: K) => void, valueWriter: (writer: SharpPackWriter, value: V) => void): void {
        if (value == null) {
            this.writeNullCollectionHeader();
            return;
        }
    ...
    public writeSet<T>(value: Set<T> | null, elementWriter: (writer: SharpPackWriter, element: T) => void): void {
        if (value == null) {
            this.writeNullCollectionHeader();
            return;
        }
...
""";
    ...
    public static readonly string SharpPackReader = """
// Code of SharpPack
const nullCollection = -1;
const union = 254;
const nullObject = 255;
...
export class SharpPackReader {
    ...
    public readArray<T>(elementReader: (reader: SharpPackReader) => T): T[] | null {
        const [ok, length] = this.tryReadCollectionHeader();
        if (!ok) {
            return null;
        }
    ...
    public readMap<K, V>(keyReader: (reader: SharpPackReader) => K, valueReader: (reader: SharpPackReader) => V): Map<K, V> | null {
        const [ok, length] = this.tryReadCollectionHeader();
        if (!ok) {
            return null;
        }
    ...
    public readSet<T>(elementReader: (reader: SharpPackReader) => T): Set<T> | null {
        const [ok, length] = this.tryReadCollectionHeader();
        if (!ok) {
            return null;
        }
