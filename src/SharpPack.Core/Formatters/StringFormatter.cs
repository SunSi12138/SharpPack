...
[Preserve]
public sealed class StringFormatter : SharpPackFormatter<string>
{
    public static readonly StringFormatter Default = new StringFormatter();

    [Preserve]
    public override void Serialize<TBufferWriter>(ref SharpPackWriter<TBufferWriter> writer, scoped ref string? value)
    {
        writer.WriteString(value);
    }

    [Preserve]
    public override void Deserialize(ref SharpPackReader reader, scoped ref string? value)
    {
...
[Preserve]
public sealed class Utf8StringFormatter : SharpPackFormatter<string>
{
...
[Preserve]
public sealed class Utf16StringFormatter : SharpPackFormatter<string>
{
...
[Preserve]
public sealed class InternStringFormatter : SharpPackFormatter<string>
{
...
[Preserve]
public sealed class BrotliStringFormatter : SharpPackFormatter<string>
{
    ...
    public override void Deserialize(ref SharpPackReader reader, scoped ref string? value)
    {
        ...
        {
            SharpPackSerializationException.ThrowDecompressionSizeLimitExceeded(decompressionSizeLimit, byteLength);
        }
