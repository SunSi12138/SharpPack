...
[Preserve]
public sealed class GenericCollectionFormatter<TCollection, TElement> : SharpPackFormatter<TCollection?>
    where TCollection : ICollection<TElement?>, new()
{
    [Preserve]
    public override void Serialize<TBufferWriter>(ref SharpPackWriter<TBufferWriter> writer, scoped ref TCollection? value)
    {
        if (value == null)
        {
    ...
    [Preserve]
    public override void Deserialize(ref SharpPackReader reader, scoped ref TCollection? value)
    {
...
[Preserve]
public abstract class GenericSetFormatterBase<TSet, TElement> : SharpPackFormatter<TSet?>
    where TSet : ISet<TElement?>
{
    ...
    [Preserve]
    public override void Serialize<TBufferWriter>(ref SharpPackWriter<TBufferWriter> writer, scoped ref TSet? value)
    {
        if (value == null)
        {
            writer.WriteNullCollectionHeader();
    ...
    [Preserve]
    public override void Deserialize(ref SharpPackReader reader, scoped ref TSet? value)
    {
        if (!reader.TryReadCollectionHeader(out var length))
        {
            value = default;
...
[Preserve]
public abstract class GenericDictionaryFormatterBase<TDictionary, TKey, TValue> : SharpPackFormatter<TDictionary?>
    where TKey : notnull
    where TDictionary : IDictionary<TKey, TValue?>
{
    ...
    [Preserve]
    public override void Serialize<TBufferWriter>(ref SharpPackWriter<TBufferWriter> writer, scoped ref TDictionary? value)
    {
        if (value == null)
        {
            writer.WriteNullCollectionHeader();
    ...
    [Preserve]
    public override void Deserialize(ref SharpPackReader reader, scoped ref TDictionary? value)
    {
        if (!reader.TryReadCollectionHeader(out var length))
        {
            value = default;
