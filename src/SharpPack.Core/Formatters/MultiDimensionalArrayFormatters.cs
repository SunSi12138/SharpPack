...
[Preserve]
public sealed class TwoDimensionalArrayFormatter<T> : SharpPackFormatter<T?[,]>
{
    ...
    public override void Deserialize(ref SharpPackReader reader, scoped ref T?[,]? value)
    {
        ...
        if (propertyCount != 3)
        {
            SharpPackSerializationException.ThrowInvalidPropertyCount(3, propertyCount);
        }
        ...
        {
            SharpPackSerializationException.ThrowInvalidCollection();
        }
...
[Preserve]
public sealed class ThreeDimensionalArrayFormatter<T> : SharpPackFormatter<T?[,,]>
{
    ...
    public override void Deserialize(ref SharpPackReader reader, scoped ref T?[,,]? value)
    {
        ...
        if (propertyCount != 4)
        {
            SharpPackSerializationException.ThrowInvalidPropertyCount(4, propertyCount);
        }
...
[Preserve]
public sealed class FourDimensionalArrayFormatter<T> : SharpPackFormatter<T?[,,,]>
{
    ...
    public override void Deserialize(ref SharpPackReader reader, scoped ref T?[,,,]? value)
    {
        ...
        if (propertyCount != 5)
        {
            SharpPackSerializationException.ThrowInvalidPropertyCount(5, propertyCount);
        }
