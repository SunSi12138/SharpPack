...
internal static partial class FormatterResolver
{
        ...
        bool preferKnownGenericFormatter)
    {
        ...
        // Can't resolve formatter, return null(will create ErrorSharpPackFormatter<T>).
        return null;
...
internal sealed class ErrorSharpPackFormatter<T> : SharpPackFormatter<T>
{
    readonly Exception? exception;
    readonly string? message;

    public ErrorSharpPackFormatter()
    {
        this.exception = null;
        this.message = null;
    }

    public ErrorSharpPackFormatter(Exception exception)
    {
        this.exception = exception;
        this.message = null;
    }

    public ErrorSharpPackFormatter(string message)
    {
        this.exception = null;
    ...
    void Throw()
    {
        ...
        {
            SharpPackSerializationException.ThrowMessage(message);
        }
        else
        {
            throw new SharpPackSerializationException(
