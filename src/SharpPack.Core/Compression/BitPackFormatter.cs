...
[Preserve]
public sealed class BitPackFormatter : SharpPackFormatter<bool[]>
{
    public static readonly BitPackFormatter Default = new BitPackFormatter();

    [Preserve]
    public override void Serialize<TBufferWriter>(ref SharpPackWriter<TBufferWriter> writer, scoped ref bool[]? value)
    {
        if (value == null)
        {
    ...
    [Preserve]
    public override void Deserialize(ref SharpPackReader reader, scoped ref bool[]? value)
    {
